...
Every clip needs provenance: source URL, title, fair-use note, start/end times, local path, which beat uses it. Mystery clips are rejected. See skill **youtube-provenance** and [[ventures/youtube-editor]].
