...
3. **Large Language Model contradiction judge** - optional Large Language Model pass over heuristic lint warnings / claim sets; human still approves material wiki edits.
...
| W2 | Large Language Model contradiction judge | Extends existing `brain:lint`; lower infra than MCP |
