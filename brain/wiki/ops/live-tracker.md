...
Auto-written by `npm run sync` at **2026-09-02T23:02:58.216Z**. Do not hand-edit — re-run sync after venture gates.
...
| Kingdom ops (subs + expenses) | v1.0 | 70% | — | P1 · active | Cancel/review 6 kill-list seats; reclaim low-risk disk (52.1% used) |
| Mac optimize audit | v0.1 | 67% | — | P1 · active | Memory pressure is warning |
| Job Jugaad | Tracker v0.1 | 43950088% | — | P1 · active | Keep logging — 439/500 toward milestone |
