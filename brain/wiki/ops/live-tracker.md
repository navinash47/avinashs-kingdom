...
Auto-written by `npm run sync` at **2026-09-02T03:48:40.765Z**. Do not hand-edit — re-run sync after venture gates.
...
| Procedural City | Stage E · Phase 52 | 57% | 52/92 | P1 · active | Phase 52: District-coherent batch planning (pending) |
| ComicMainEngine | 2A · A1 passed · A2 Scene cards + storyboard ingest | 33% | 2/6 | P2 · active | A2 Scene cards + storyboard ingest (start) |
| Kingdom ops (subs + expenses) | v1.0 | 70% | — | P1 · active | Cancel/review 6 kill-list seats; reclaim low-risk disk (51.5% used) |
| Mac optimize audit | v0.1 | 52% | — | P1 · active | Memory pressure is urgent |
