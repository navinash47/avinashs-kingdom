...
Auto-written by `npm run sync` at **2026-09-03T04:09:01.538Z**. Do not hand-edit - re-run sync after venture gates.
...
| YouTube editor + screenplay | Phase 4 · Clip research + provenance | 55% | - | P0 · active | Add Google creds (`GOOGLE_APPLICATION_CREDENTIALS` + `GCS_BUCKET` or Drive folder) to set `CLIP_CLOUD=gcs` and re-run `npm run clips:fetch` to sync cloud. |
